            ...
            lock (_historyGate)
            {
                ...
                try
                {
                    ...
                    return new ShadowAwareGarbageCollectionResult(
                        ...
                        ProjectionConstructionMilliseconds: analysis.ConstructionMilliseconds,
                        CoreProjectionMilliseconds: analysis.CoreProjectionMilliseconds,
                        ObserverVerificationMilliseconds: analysis.ObserverVerificationMilliseconds,
...
public sealed record ShadowAwareGarbageCollectionResult(
    ...
    double ProjectionConstructionMilliseconds,
